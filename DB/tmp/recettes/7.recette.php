<?php
$titre ="Entrée méditerranéenne";
$ingredients = [];

array_push($ingredients,["2kg", "fèves"]);
array_push($ingredients,["1", "jus d'un citron"]);
array_push($ingredients,["2-3cs", "huile d'olive"]);
array_push($ingredients,["0", "sel"]);
array_push($ingredients,["0", "poivre"]);
array_push($ingredients,["0", "cumin"]);
array_push($ingredients,["0", "coriandre "]);
...
2. Une fois les fèves dérobées et refroidies, préparez la vinaigrette en mélangeant l'huile d'olive, le sel, le citron et le cumin. Incorporez aux fèves dans un saladier et ciselez quelques brins de coriandre par dessus.

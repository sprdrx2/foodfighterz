<?php
$titre ="Douceur de pamplemousse au citron vert";
$ingredients = [];

array_push($ingredients,["1", "concombre"]);
array_push($ingredients,["2", "pamplemousse"]);
array_push($ingredients,["1bouquet", "ciboulette"]);
array_push($ingredients,["25cl", "lait de coco"]);
array_push($ingredients,["1cc", "cumin"]);
array_push($ingredients,["1", "citron vert"]);

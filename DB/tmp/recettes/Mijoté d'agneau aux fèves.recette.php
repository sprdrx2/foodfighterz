<?php
$titre ="Mijoté d'agneau aux fèves";
$ingredients = [];

array_push($ingredients,["800g", "agneau "]);
array_push($ingredients,["3kg", "fèves"]);
array_push($ingredients,["400g", "épinards"]);
array_push($ingredients,["8gousses", "ail"]);
array_push($ingredients,["2cs", "concentré de tomates"]);
array_push($ingredients,["1cs", "cumin"]);
array_push($ingredients,["1cc", "piment"]);
array_push($ingredients,["1bouquet", "coriandre"]);

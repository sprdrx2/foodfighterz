<?php
$titre ="Salade de pois chiches et carottes au cumin";
$ingredients = [];

array_push($ingredients,["1bocal", "pois chiches"]);
array_push($ingredients,["4", "carottes"]);
array_push($ingredients,["1", "oignon doux "]);
array_push($ingredients,["2cs", "jus de citron"]);
array_push($ingredients,["5", "cs huile d'olive"]);
array_push($ingredients,["2-3cs", "cumin en poudre"]);
